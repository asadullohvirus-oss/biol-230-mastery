# Operations and Critical Dependencies
...
Official contract end: UNKNOWN — retrieve from myAU
Personal completion target: 2026-12-01 to 2026-12-05
...
myAU:
- most complete/accurate grade record,
- exam requests,
- transcript requests,
...
### Midterm 2
Coverage: Units 3–4 / Chapters 9–15
Academic readiness: Not ready
Exam requested: No
Request date:
Scheduled date:
...
### Final
Coverage: Units 5–6 / Chapters 16–23
Academic readiness: Not ready
Exam requested: No
Request date:
Scheduled date:
...
[ ] Home Lab Kit activities complete (0/6)
...
Instructor feedback is expected by email within eight business days after a quiz and identifies the textbook learning objective related to each incorrect response.

On feedback receipt:
1. capture the missed objective,
2. diagnose the error,
3. remediate,
4. retest,
5. update MASTERY/MISTAKES if warranted.
...
→ verify official grade in myAU
→ transcript available/requested
→ Dalhousie application evidence ready before 2027-01-17
